          ...
          <a-tab-pane style="height: 500px;" key="create" :tab="$t('business.homework.createNew')">
            ...
            <div v-show="ifTeacher">
              ...
              <Input style="margin-bottom: 10px;width: 80%;position: relative;left: 10%;" v-model="update2"
                     ...
                     placeholder="课程简介"/>
              <Input style="margin-bottom: 10px;width: 80%;position: relative;left: 10%;" v-model="update3"
                     placeholder="讲师"/>
              <Input style="margin-bottom: 10px;width: 80%;position: relative;left: 10%;" v-model="update4"
                     placeholder="助教"/>
              <a-button @click="createNewCourse" type="primary" size="default"
